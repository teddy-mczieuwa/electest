$(function () { 
    ...
    // require database service conditionally to avoid error 
    // error occurs because db is a function call
    // and model may or may not exist
    ...
    async function  readData() {
        ...
        db = this.dataset.name ? require('./dbService')(this.dataset.name) : null
